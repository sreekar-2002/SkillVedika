    ...
    <section className="py-16 px-6 bg-white relative">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="overflow-hidden relative px-8">
          ...
          >
            {slides.map((group, i) => (
              <div key={i} className="min-w-full grid grid-cols-1 md:grid-cols-3 gap-10 px-4 items-stretch">
                {group.map((b: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <h3 className="text-lg font-bold text-gray-900 mb-2 line-clamp-2">{b.title}</h3>
